...
export default {
  ...
  methods: {
    ...
    checkPasswordMatch() {
      this.errors.confirmPassword = this.customer.password !== this.customer.confirmPassword ? 'Passwords do not match' : '';
    },
    checkPasswordMatchC() {
      this.errors.confirmPasswordC = this.contractor.password !== this.contractor.confirmPassword ? 'Passwords do not match' : '';
    },
    registerUser() {
      // Reset errors
      this.errors = {};
      // Basic validation
      if (!this.customer.firstName) this.errors.firstName = 'First name is required';
      if (!this.customer.lastName) this.errors.lastName = 'Last name is required';
      if (!this.customer.email) this.errors.email = 'Email is required';
      if (!this.customer.password) this.errors.password = 'Password is required';
      if (this.customer.password !== this.customer.confirmPassword) this.errors.confirmPassword = 'Passwords do not match';
    ...
    this.errors = {};
      // Basic validation
      if (!this.contractor.firstName) this.errors.firstNameC = 'First name is required';
      if (!this.contractor.lastName) this.errors.lastNameC = 'Last name is required';
      if (!this.contractor.companyName) this.errors.companyName = 'Company name is required';
      if (!this.contractor.companyEmail) this.errors.companyEmail = 'Company email is required';
      if (!this.contractor.password) this.errors.passwordC = 'Password is required';
      if (this.contractor.password !== this.contractor.confirmPassword) this.errors.confirmPasswordC = 'Passwords do not match';

      // Validate email format
      const emailPattern = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
      if (this.contractor.companyEmail && !emailPattern.test(this.contractor.companyEmail)) {
        this.errors.companyEmail = 'Invalid email format';
      }

      if (Object.keys(this.errors).length === 0) {
        // Call your registration API here
        console.log('Registering contractor:', this.contractor);
        // Reset form
      ...
      <div class="col-lg-6 col-12 form-container">
        <div class="registration-form">
          ...
          <div class="mb-3">
            ...
            <div class="error" v-if="errors.accountType">{{ errors.accountType }}</div>
          </div>
          ...
          <div v-if="accountType === 'customer'" id="customerFields">
            ...
            <div class="mb-3">
              ...
              <div class="input-group">
                ...
                >
                  <i :class="passwordVisible ? 'fa-solid fa-eye-slash' : 'fa-solid fa-eye'" id="eye-icon-password"></i>
                </span>
              </div>
              <div class="strength-indicator" v-if="passwordStrength">{{ passwordStrength }}</div>
            ...
            <div class="mb-3">
              ...
              <div class="input-group">
                ...
                >
                  <i :class="confirmPasswordVisible ? 'fa-solid fa-eye-slash' : 'fa-solid fa-eye'" id="eye-icon-confirmPassword"></i>
                </span>
              </div>
            ...
            <div class="d-grid mb-3">
              <button class="btn register-btn" type="button" @click="registerUser">Create Account</button>
            </div>
          ...
          <div v-if="accountType === 'contractor'" id="contractorFields">
            <div class="mb-3">
              ...
              <input
                ...
                required
              />
              <div class="error" v-if="errors.firstNameC">{{ errors.firstNameC }}</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <input
                ...
                required
              />
              <div class="error" v-if="errors.lastNameC">{{ errors.lastNameC }}</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="input-group">
                ...
                >
                  <i :class="passwordCVisible ? 'fa-solid fa-eye-slash' : 'fa-solid fa-eye'" id="eye-icon-passwordC"></i>
                </span>
              </div>
              <div class="strength-indicator" v-if="passwordCStrength">{{ passwordCStrength }}</div>
              <div class="error" v-if="errors.passwordC">{{ errors.passwordC }}</div>
            </div>

            <div class="mb-3">
              <label for="confirmPasswordC" class="form-label">Confirm Password</label>
              <div class="input-group">
                <input
                ...
                >
                  <i :class="confirmPasswordCVisible ? 'fa-solid fa-eye-slash' : 'fa-solid fa-eye'" id="eye-icon-confirmPasswordC"></i>
                </span>
              </div>
              <div class="error" v-if="errors.confirmPasswordC">{{ errors.confirmPasswordC }}</div>
            </div>

            <div class="d-grid mb-3">
              <button class="btn register-btn" type="button" @click="registerUserC">Create Account</button>
            </div>
          </div>
        </div>
      </div>
